...
{
    {COMPOUND_STRING("STONE BADGE")},
    {COMPOUND_STRING("KNUCKLE BADGE")},
    {COMPOUND_STRING("DYNAMO BADGE")},
    {COMPOUND_STRING("HEAT BADGE")},
    {COMPOUND_STRING("BALANCE BADGE")},
    {COMPOUND_STRING("FEATHER BADGE")},
    {COMPOUND_STRING("MIND BADGE")},
    {COMPOUND_STRING("RAIN BADGE")},
    {gText_Exit},
};

static const struct MenuAction MultichoiceList_AnabelMegas[] =
{
...
static const struct MenuAction MultichoiceList_AnabelGMegas[] = 
{
...
static const struct MenuAction MultichoiceList_AnabelCollections[] =
{
    {COMPOUND_STRING("STANDARD COLLECTION")},
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_ANABEL_MEGAS]               = MULTICHOICE(MultichoiceList_AnabelMegas),
    [MULTI_ANABEL_GMEGAS]              = MULTICHOICE(MultichoiceList_AnabelGMegas),
