...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_CHESPIN] =
    {
        ...
        .abilities = { ABILITY_BULLETPROOF, ABILITY_NONE, ABILITY_OVERGROW },
    ...
    [SPECIES_FENNEKIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_MAGICIAN, ABILITY_NONE, ABILITY_BLAZE },
    ...
    [SPECIES_FROAKIE] =
    {
        ...
        .abilities = { ABILITY_PROTEAN, ABILITY_NONE, ABILITY_TORRENT },
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    ...
    [SPECIES_ESPURR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_MEOWSTIC_F, CONDITIONS({IF_GENDER, MON_FEMALE})},
                                {EVO_LEVEL, 25, SPECIES_MEOWSTIC_M, CONDITIONS({IF_GENDER, MON_MALE})}),
    },
